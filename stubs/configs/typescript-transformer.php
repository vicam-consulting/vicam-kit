...
use App\Support\Typescript\FlatExportWriter;
use Carbon\Carbon;
...
return [
     ...
     *
     * Custom writer that generates namespaced module exports (e.g., App.Data.Responses.*).
     * This allows Vue SFC compiler to resolve types in defineProps<> generics
     * while maintaining PHP-style namespace organization.
     */

    'writer' => FlatExportWriter::class,
