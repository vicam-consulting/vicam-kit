...
return [
     ...
     */
    'date_format' => [
        'Y-m-d\TH:i:s.u\Z', // ISO with milliseconds and literal Z (UTC), e.g. 2025-09-02T08:48:00.000Z
        'Y-m-d\TH:i:s\Z',   // ISO with seconds and literal Z (UTC), e.g. 2025-09-02T08:48:00Z
        'Y-m-d\TH:i:sP',     // ISO with seconds and numeric offset, e.g. 2025-09-02T08:48:00-07:00
        'Y-m-d',              // date-only inputs (e.g., dateOfBirth)
        'Y-m-d\TH:i',        // datetime-local inputs (no seconds), e.g. 2025-09-02T08:48
    ],
